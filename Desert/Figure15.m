...
noise = ReadSegy('residual_of_BPF.segy');
...
noise = ReadSegy('residual_of_VMD.segy');
figure; imagesc(noise); colorbar;
xlabel('Trace'); ylabel('Time (ms)');
set(gca, 'xticklabel', get(gca, 'xtick') * 1);
set(gca, 'yticklabel', get(gca, 'ytick') * 2);
...
noise = ReadSegy('residual_of_WNNM.sgy');
figure; imagesc(noise); colorbar;
xlabel('Trace'); ylabel('Time (ms)');
set(gca, 'xticklabel', get(gca, 'xtick') * 1);
set(gca, 'yticklabel', get(gca, 'ytick') * 2);
...
noise = ReadSegy('residual_of_Transformer.segy');
figure; imagesc(noise); colorbar;
xlabel('Trace'); ylabel('Time (ms)');
set(gca, 'xticklabel', get(gca, 'xtick') * 1);
set(gca, 'yticklabel', get(gca, 'ytick') * 2);
...
noise = ReadSegy('residual_of_Diffusion.segy');
figure; imagesc(noise); colorbar;
xlabel('Trace'); ylabel('Time (ms)');
set(gca, 'xticklabel', get(gca, 'xtick') * 1);
set(gca, 'yticklabel', get(gca, 'ytick') * 2);
