...
data_sdrt = ReadSegy('result_of_BPF.sgy');
...
data_sdrt = ReadSegy('result_of_VMD.sgy');
figure; imagesc(data_sdrt); colorbar;
xlabel('Trace'); ylabel('Time (ms)');
set(gca, 'xticklabel', get(gca, 'xtick') * 1);
set(gca, 'yticklabel', get(gca, 'ytick') * 2);
...
data_sdrt = ReadSegy('result_of_WNNM.segy');
figure; imagesc(data_sdrt); colorbar;
xlabel('Trace'); ylabel('Time (ms)');
set(gca, 'xticklabel', get(gca, 'xtick') * 1);
set(gca, 'yticklabel', get(gca, 'ytick') * 2);
...
data_sdrt = ReadSegy('result_of_Transformer.sgy');
figure; imagesc(data_sdrt); colorbar;
xlabel('Trace'); ylabel('Time (ms)');
set(gca, 'xticklabel', get(gca, 'xtick') * 1);
set(gca, 'yticklabel', get(gca, 'ytick') * 2);
